...
public extension UITableView
{
    ...
    func indexPathFromButton(selectedButton : UIButton) -> NSIndexPath {
        let center = selectedButton.center;
        let rootViewPoint = selectedButton.superview?.convertPoint(center, toView: self)
        return self.indexPathForRowAtPoint(rootViewPoint!)!
    }
}